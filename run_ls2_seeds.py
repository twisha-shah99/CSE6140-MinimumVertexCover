#!/usr/bin/env python3
"""
Run LS2 over 20 predefined seeds per instance.
...
Report rounded to 2 decimal places. Save to results_ls2_seeds.txt.
"""
import os
import subprocess
import sys
...
OUT_ROOT = os.path.join(BASE, "final_outputs", "LS2_seeds")
...
def main():
        ...
        for name in names:
            ...
            for seed in SEEDS:
                ...
                trace_path = os.path.join(out_dir,
                                          f"{name}_LS2_{cutoff_str}_{seed}.trace")
    ...
    report_path = os.path.join(BASE, "results_ls2_seeds.txt")
